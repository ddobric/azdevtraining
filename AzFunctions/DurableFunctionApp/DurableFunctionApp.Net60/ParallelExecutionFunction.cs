...
namespace DurableFunctionApp
{
    ...
    {
        [FunctionName("ParallelExecutionFunction")]
        ...
        [FunctionName("HttpStartParallelExecutionFunction")]
            ...
            ILogger log)
        {
            ...
            string instanceId = await starter.StartNewAsync("ParallelExecutionFunction", null);
