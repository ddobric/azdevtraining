...
namespace Daenet.ServiceBus.NetCore
{
    internal class TopicSessionSample
    {
        ...
        static async Task RunReceiversAsync()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                tasks.Add(Task.Run(async () =>
                {
                    ...
                    var session = await m_SubscriptionClient.AcceptMessageSessionAsync();
                    ...
                    while (true)
                    {
                        ...
                        else
                        {
                            ...
                            session = await m_SubscriptionClient.AcceptMessageSessionAsync();
        ...
        static async Task ProcessMessagesAsync(Message message, CancellationToken token)
        {
            ...
            await m_.CompleteAsync(message.SystemProperties.LockToken);
        }
