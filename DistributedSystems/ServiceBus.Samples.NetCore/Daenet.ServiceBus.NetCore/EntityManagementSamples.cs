...
{
    public class EntityManagementSamples
    {
        ...
        private static Credentials appOptions;
        ...
        static EntityManagementSamples()
        {
            var builder = new ConfigurationBuilder();
            builder.AddJsonFile("appsettings.json", true, true);

            settingsCache = builder.Build();
            appOptions = new Credentials();
        ...
        private static async Task CreateRule()
        {
            try
            {
                ...
                {
                    SqlFilter = new Microsoft.Azure.Management.ServiceBus.Models.SqlFilter("myproperty='test'")
                };
